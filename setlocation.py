...
#  python setlocation.py -k <Meraki API key> [-g <Google API key>] -o <org name> -n <network name> -l <street address>
#
...
def printhelp():
	...
	print('This script updates the street address of evcery device in a network to a value given as a parameter.')
	print('Map markers will also be moved close to this address if a Google API key is given (parameter "-g").')
	print('')
	print('Script syntax:')
	print('python setlocation.py -k <Meraki API key> [-g <Google API key>] -o <org name> -n <network name> -l <street address>')
	print('')
